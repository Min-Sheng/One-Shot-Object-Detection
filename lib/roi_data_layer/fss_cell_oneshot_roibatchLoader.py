...
"""The data layer used during training to train a a one/few shot Fast R-CNN network for COCO.
"""
...
class roibatchLoader(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    if self.training:
        ...
        return padding_data, query, im_info, gt_boxes_padding, num_boxes, data_name
    else:
        ...
        return data, query, im_info, gt_boxes, choice, data_name
